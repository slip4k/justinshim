...
export default function ContactForm() {
  const [isLoading, setIsLoading] = useState('presubmit');
  ...
  return (
    <>
      {isLoading === 'presubmit' ? (
        <form
          className="flex flex-col gap-y-4 rounded-md p-6 lg:w-[40dvw] w-[90dvw] mt-10"
        ...
        >
          ...
          ></textarea>
          <button className="bg-black text-white py-4 rounded-md">
            Submit
          </button>
        </form>
      ) : isLoading === 'midsubmit' ? (
        <div className="p-24 mt-8 w-[90dvw]border rounded-md" role="status">
          <svg
            aria-hidden="true"
        ...
        <div className="p-8 mt-8 w-[90dvw] text-center border rounded-md">
